...
class Citation{
	...
	function getConferenceArticle(){
        ...
        function assemblyCitation(){
            $templateMgr = &TemplateManager::getManager();
            $templateMgr->assign_by_ref('citation', $this);

            $dynamicGalleysPlugin = &PluginRegistry::getPlugin('generic', DYNAMIC_GALLEYS_PLUGIN_NAME);
            $output = null;
            ob_start();
                $templateMgr->display($dynamicGalleysPlugin->getTemplatePath() . 'citation.tpl');
